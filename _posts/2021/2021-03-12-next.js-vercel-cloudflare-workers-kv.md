...
Cloudflare WorkersはLambdaみたいに任意のレスポンスを返せます。サイトを作るには画像などのファイルなどもそのまま扱えるほうが楽ですが、[Workers Sites](https://developers.cloudflare.com/workers/platform/sites)を使うとそれができます。

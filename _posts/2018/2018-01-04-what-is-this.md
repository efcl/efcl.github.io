...
次の場所に[js-primer](https://github.com/asciidwango/js-primer "js-primer")版のか`this`についての解説があります。
...
なぜなら、スコープチェーンの性質と同様に、そのスコープに同じ名前の変数が定義されていない場合には外側のスコープを探索するためです。

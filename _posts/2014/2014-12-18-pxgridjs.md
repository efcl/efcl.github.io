...
- [power-assert](https://github.com/twada/power-assert "power-assert")は今assertライブラリは[defunctzombie/commonjs-assert](https://github.com/defunctzombie/commonjs-assert "defunctzombie/commonjs-assert")を使ってる
- アレ??
- IE8の寿命を考えよう

...
自分は[明日には使えなくなるES7トーク](https://azu.github.io//slide/es6talks/ "明日には使えなくなるES7トーク")というES7の話をしてきました。
...
> [ECMAScript6による 関数型プログラミング](http://www.slideshare.net/TanUkkii/ecma-script6-40864841 "Ecma script6による関数型プログラミング")
...
## [明日には使えなくなるES7トーク](https://azu.github.io//slide/es6talks/ "明日には使えなくなるES7トーク") - @azu_re
...
詳しくは[明日には使えなくなるES7トーク](https://azu.github.io//slide/es6talks/ "明日には使えなくなるES7トーク")を下にスクロールするとキャプションが見えます。

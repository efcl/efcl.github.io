...
[spellcheck-tech-word](https://github.com/azu/spellcheck-tech-word-textlint-rule "spellcheck-tech-word")のようなルールでチェックするためのコマンドラインツールとNode.js``モジュールがなかったので作ったというのが始まりですが、

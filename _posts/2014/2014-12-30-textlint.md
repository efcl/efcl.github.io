...
![lint result](https://monosnap.com/image/9FeIQr95kXjGPWFjZFRq6ZFG16YscF.png)
...
![rule指定での実行例](https://efcl.info/wp-content/uploads/2014/12/30-1419923294.jpg)
...
(<del>まだparentなどが未完です</del> => 実装 [textlint 1.4 パーサの安定化、ルールの自由度の改善をして現実的に使えるLintツールへ | Web Scratch](https://efcl.info/2015/01/07/textlint1.4/ "textlint 1.4 パーサの安定化、ルールの自由度の改善をして現実的に使えるLintツールへ | Web Scratch"))
...
実際に作った技術用語のLint(このルールは[WEB+DB PRESS用語統一ルール等を使った技術用語のLintをするCodeMirrorアドオンを書いた | Web Scratch](https://efcl.info/2014/10/20/lint-tech-word/ "WEB+DB PRESS用語統一ルール等を使った技術用語のLintをするCodeMirrorアドオンを書いた | Web Scratch")と同じやつです)
...
追記: [textlint 1.4 パーサの安定化、ルールの自由度の改善をして現実的に使えるLintツールへ | Web Scratch](https://efcl.info/2015/01/07/textlint1.4/ "textlint 1.4 パーサの安定化、ルールの自由度の改善をして現実的に使えるLintツールへ | Web Scratch")

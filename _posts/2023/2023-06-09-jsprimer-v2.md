...
しかし、やってることはあくまでJavaScriptのコードを出力するだけなので、表現力の限界はJavaScriptの機能に依存します。つまり、どんなに頑張っても、JavaScriptの機能を超えることはできません。
...
## JavaScript Primerは変化に対応するためのプロジェクト

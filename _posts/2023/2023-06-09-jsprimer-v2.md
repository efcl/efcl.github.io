...
ECMAScriptは毎年更新されますが、更新は1年に1度です。
一方の<https://tc39.es/ecma262/>で公開されているECMAScriptは常に更新されるLiving Standardです。
そのため、[tc39/ecma262](https://github.com/tc39/ecma262)へ毎日のようにコミットされています。

...
コミットするのは習慣なので特に意識はしてないけど、[去年も書いた](http://efcl.info/2014/12/31/oss-in-2014/)けど[jser/jser.info](https://github.com/jser/jser.info "jser/jser.info")とかのブログ周りが入ってるのと、移動中とか空いてる時間にコミットしているのが影響してる。

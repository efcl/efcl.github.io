...
- [azu/pdf-markdown-annotator](https://github.com/azu/pdf-markdown-annotator "azu/pdf-markdown-annotator")
	...
	- [ECMAScript 6 読書メモ](https://azu.github.io//annotation-memo/es6/)
	- [ECMAScript 6 draft 読書メモ](https://azu.github.io//annotation-memo/es6-draft/)
	- [ECMAScript 5 読書メモ](https://azu.github.io//annotation-memo/es5/)
...
- [azu/npm-relative-version](https://github.com/azu/npm-relative-version "azu/npm-relative-version")
	...
	- [ロジック、E2E、描画、音、動画、Example、文章 - 色々なJSテスト](https://azu.github.io//slide/assistant-bucho/test-everything.html "ロジック、E2E、描画、音、動画、Example、文章 - 色々なJSテスト")
- [azu/stemming-x-keywords](https://github.com/azu/stemming-x-keywords "azu/stemming-x-keywords")
	- 文章からキーワードを取り出すやつ
- [Introduction | ECMAScriptとは何か？](https://azu.github.io//slide-what-is-ecmascript/)
...
- [GitHub Ribbon Generator](https://azu.github.io//github-ribbon-generator/ "GitHub Ribbon Generator")
...
[去年](https://efcl.info/2014/12/31/oss-in-2014/)は[JavaScript Promiseの本](https://azu.github.io//promises-book/ "JavaScript Promiseの本")を書いていたけど、今年は書くためのツールや手法を考えるのを目的にした
...
- [JavaScript Promiseの本](https://azu.github.io//promises-book/ "JavaScript Promiseの本")のVer 2.0がでるといいな

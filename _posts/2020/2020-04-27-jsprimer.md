...
**追記:** 現在は改訂版が出ています → [JavaScript Primer 改訂2版をリリースしました！/JavaScript Primerはなぜ更新され続けるのか？ | Web Scratch](https://efcl.info/2023/06/09/jsprimer-v2/)
...
- 電子書籍
  - Kindle: [JavaScript Primer　迷わないための入門書 (アスキードワンゴ) | azu, Suguru Inatomi | 工学 | Kindleストア | Amazon](https://www.amazon.co.jp/dp/B0899J4LY1/)
...
書籍の内容もコードはMITライセンス、文章は~~CC BY-NC 4.0~~ <ins>CC BY 4.0</ins>(v5.0.0でライセンスを変更)で公開しているため、[ライセンス](https://github.com/asciidwango/js-primer#license)の範囲内なら自由に扱えます。
...
JavaScript Primer v5.0.0からライセンスをCC BYに変更し、商用利用でも自由に利用できるようになりました。
そのため、教材としての利用などは、著作者表示さえしていれば特に許可なくできます。
...
書籍をOSSで開発する理由としては、継続的にメンテンスするためです。また、無料で公開するのはどこからでも参照がしやすい教科書的なものが欲しかったからです。

...
一緒に手伝ってくれる人は、いつでも募集しているのでTypeScript周りを改善したい人は上のIssueを見てみてください。(個人的には[@textlint/kernel](https://github.com/textlint/textlint/tree/master/packages/%40textlint/kernel "@textlint/kernel")のPublic APIのテストがまだ足りていな印象です)

## 🔥 Breaking Change

10.0.0なのでいくつか破壊的な変更がありますが、textlintをCLIとして使う一般的なユーザーには殆ど影響がないはず。
...
これによって一部importの仕方によっては影響があるかもしれません。

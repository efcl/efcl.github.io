...
- 動画: <https://www.youtube.com/watch?v=r5CZdn8IQlc&list=PLU3cbyaBojDbaZn45yAE9ZQMOmG-P4R5r&index=8>
...
そのため、入門書としての目的としてオープンソースに関わってもらうことを入れています。これはjsprimerをオープンソースで開発している理由の一つです。
...
Ask the speakerでもあった気がしますが、文章を読んでる時の人間のコンテキストはかなり小さいので、jsprimerを書くときは一度に読むべきコンテキストを絞るイメージで書いています(文章ではジャンプが難しいという前提があります)。

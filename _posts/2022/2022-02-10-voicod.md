---
title: "音声入力でメモを書けるウェブアプリを書いた、x-callback-url対応"
author: azu
layout: post
...
- → OKボタンを押すと、 "https://github.com/azu/voicod/issues/new?title={{result}}" が開かれる例です
...
- → 音声を入力すると "https://github.com/azu/voicod/issues/new?title={{result}}" が自動的に開かれます。

...
- JavaScriptCode
	- SourceCode
		...
		- -> DFG Compiler
		- -> FTG Compiler
	- [Introducing the B3 JIT Compiler | WebKit](https://webkit.org/blog/5852/introducing-the-b3-jit-compiler/ "Introducing the B3 JIT Compiler | WebKit")
- 最適化について
...
- サーバをブラウザで
	...
	- オフラインでも動く
	- JavaScript無効でも動く
	- クライアントサイドのサーバサイドのJavaScriptでサーバサイドレンダリングしてる

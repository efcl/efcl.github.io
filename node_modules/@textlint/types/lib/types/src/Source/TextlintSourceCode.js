 ...
 */
var TextlintSourceCode = /** @class */ (function () {
    /**
     * @param {string} text
     * @param {Object} ast
     * @param {string} ext
     ...
     */
    function TextlintSourceCode(_a) {
     ...
     */
    TextlintSourceCode.prototype.getSyntax = function () {
     ...
     */
    TextlintSourceCode.prototype.getFilePath = function () {
     ...
     */
    TextlintSourceCode.prototype.getSource = function (node, beforeCount, afterCount) {
     ...
     */
    TextlintSourceCode.prototype.locationToRange = function (loc) {
     ...
     */
    TextlintSourceCode.prototype.rangeToLocation = function (range) {
     ...
     * @return {number} index.
     */
    TextlintSourceCode.prototype.positionToIndex = function (pos) {
     ...
     */
    TextlintSourceCode.prototype.indexToPosition = function (index) {
        return this._structuredSource.indexToPosition(index);
    };
    return TextlintSourceCode;
}());
exports.TextlintSourceCode = TextlintSourceCode;
//# sourceMappingURL=TextlintSourceCode.js.map